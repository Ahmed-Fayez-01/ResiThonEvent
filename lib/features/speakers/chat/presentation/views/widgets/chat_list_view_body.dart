...
class ChatListViewBody extends StatelessWidget {
  const ChatListViewBody({Key? key, required this.sessionId, required this.name}) : super(key: key);
  final int sessionId;
  final String name  ;
  @override
  Widget build(BuildContext context) {
    ...
    print("mostafa");
    return BlocProvider(
      create: (context) => SpeakerChatCubit(getIt.get<SpeakersChatRepoImpl>(),)..getAllUsersInChatList(sessionId: sessionId),
         ...
         return Padding(
           ...
           child: Column(
             ...
             children: [
               ...
               ChatsPublicGroupBody(sessionId: sessionId, name: name),
               SizedBox(
                 height: AppConstants.height10(context),
               ),
               Text(
